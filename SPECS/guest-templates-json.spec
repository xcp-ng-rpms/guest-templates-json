...
Version: 2.1.1
Release: 1%{?xsrel}.1~ydi1.1%{?dist}
License: BSD
Source0: guest-templates-json-2.1.1.tar.gz

# XCP-ng patches
Source1001: centos-stream-8.json
Source1002: debian-13.json
Source1003: oel-9.json
Source1004: oel-10.json
Source1005: rocky-10.json
Source1006: generic-linux-bios.json
Source1007: generic-linux-uefi.json
BuildArch: noarch
